...
from yolo_feature_extractor import create_domain_adapted_model
from domain_data_loader import DomainAwareTrainerMixin
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                if hasattr(self, 'RANK') and self.RANK in (-1, 0):
                    ...
                    losses = self.tloss if loss_len > 1 else torch.unsqueeze(self.tloss, 0) if self.tloss is not None else [0]
